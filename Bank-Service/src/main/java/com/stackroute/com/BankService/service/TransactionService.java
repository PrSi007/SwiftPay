...
public class TransactionService implements TransactionServiceInterface {
    ...
    public void executeCredit(String message) throws IOException {
        ...
        System.out.println(accountNumber);
        Optional<AccountModel> optional;
        try {
            System.out.println("inside find account" + accountNumber);
            optional = accountRepository.findByAccountNumber(accountNumber);
        } catch (Exception e) {
            throw new NullPointerException("account number is null bsdk*********************************************************************************");
        }
